...
public interface ISimJoin<T> {
	 ...
	 * @param threshold
	 *            The similarity threshold (between 0 and 1).
	 * @param results
	 *            The pairs having similarity above the threshold.
	 */
	 ...
	 * 
	 * @param collection1
	 *            The left collection to join.
	 * @param collection2
	 *            The right collection to join.
	 * @param threshold
	 *            The similarity threshold (between 0 and 1).
	 * @param results
	 *            The pairs having similarity above the threshold.
	 ...
	 * @param results
	 *            The k-nearest neighbors for each group in the collection.
	 */
	public void knnJoin(GroupCollection<T> collection, int k, ConcurrentLinkedQueue<MatchingPair> results);
	 ...
	 *            The number of nearest neighbors.
	 * @param results
	 *            The k-nearest neighbors for each group in the left collection.
	 */
	public void knnJoin(GroupCollection<T> collection1, GroupCollection<T> collection2, int k,
			ConcurrentLinkedQueue<MatchingPair> results);
	 ...
	 * @param results
	 *            The k pairs having the highest similarity score.
	 */
